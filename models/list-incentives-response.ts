...
import { ListIncentivesResponseData } from './list-incentives-response-data';

/**
 * Response schema listing many incentives
 * @export
 * @interface ListIncentivesResponse
 */
export interface ListIncentivesResponse {
    /**
     * 
     * @type {ListIncentivesResponseData}
     * @memberof ListIncentivesResponse
     */
    'data'?: ListIncentivesResponseData;
}
