...
import { RecurringIncentiveResponseData } from './recurring-incentive-response-data';

/**
 * Recurring Incentive response
 * @export
 * @interface RecurringIncentiveResponse
 */
export interface RecurringIncentiveResponse {
    /**
     * 
     * @type {RecurringIncentiveResponseData}
     * @memberof RecurringIncentiveResponse
     */
