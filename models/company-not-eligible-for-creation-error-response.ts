 ...
 * @export
 * @interface CompanyNotEligibleForCreationErrorResponse
 */
export interface CompanyNotEligibleForCreationErrorResponse {
    /**
     * 
     * @type {string}
     * @memberof CompanyNotEligibleForCreationErrorResponse
     */
    'code'?: string;
    /**
     * 
