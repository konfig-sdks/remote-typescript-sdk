...
import { BenefitsCountrySummary } from './benefits-country-summary';

/**
 * 
 * @export
 * @interface ListBenefitsCountrySummaryResponseData
 */
export interface ListBenefitsCountrySummaryResponseData {
    /**
     * 
     * @type {string}
     * @memberof ListBenefitsCountrySummaryResponseData
     */
    'company_id': string;
    /**
     * 
     * @type {Array<BenefitsCountrySummary>}
     * @memberof ListBenefitsCountrySummaryResponseData
     */
    'country_summaries': Array<BenefitsCountrySummary>;
}
