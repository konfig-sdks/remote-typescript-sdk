...
import { CostCalculatorCountryLevelRegion } from './cost-calculator-country-level-region';

/**
 * 
 * @export
 * @interface CostCalculatorListCountryResponse
 */
export interface CostCalculatorListCountryResponse {
    /**
     * 
     * @type {Array<CostCalculatorCountryLevelRegion>}
     * @memberof CostCalculatorListCountryResponse
     */
