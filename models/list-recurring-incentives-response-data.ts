...
import { RecurringIncentive } from './recurring-incentive';

/**
 * 
 * @export
 * @interface ListRecurringIncentivesResponseData
 */
export interface ListRecurringIncentivesResponseData {
    /**
     * The current page among all of the total_pages
     * @type {number}
     * @memberof ListRecurringIncentivesResponseData
     */
    'current_page'?: number;
    /**
     * 
     * @type {Array<RecurringIncentive>}
     * @memberof ListRecurringIncentivesResponseData
     */
