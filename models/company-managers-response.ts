...
import { CompanyManagersResponseData } from './company-managers-response-data';

/**
 * Response schema listing many company_managers
 * @export
 * @interface CompanyManagersResponse
 */
export interface CompanyManagersResponse {
    /**
     * 
     * @type {CompanyManagersResponseData}
     * @memberof CompanyManagersResponse
     */
    'data'?: CompanyManagersResponseData;
}
