 ...
 * 
 * @export
 * @interface IdentityCustomerAccessTokenResponse
 */
export interface IdentityCustomerAccessTokenResponse {
    /**
     * 
     * @type {IdentityCustomerAccessTokenResponseData}
     * @memberof IdentityCustomerAccessTokenResponse
     */
    'data': IdentityCustomerAccessTokenResponseData;
}
