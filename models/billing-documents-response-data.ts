...
import { BillingDocumentsResponseDataBillingDocumentsInner } from './billing-documents-response-data-billing-documents-inner';

/**
 * 
 * @export
 * @interface BillingDocumentsResponseData
 */
export interface BillingDocumentsResponseData {
    /**
     * 
     * @type {Array<BillingDocumentsResponseDataBillingDocumentsInner>}
     * @memberof BillingDocumentsResponseData
     */
    'billing_documents': Array<BillingDocumentsResponseDataBillingDocumentsInner>;
    /**
