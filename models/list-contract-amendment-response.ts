...
import { ListContractAmendmentResponseData } from './list-contract-amendment-response-data';

/**
 * Response schema listing many contract_amendments
 * @export
 * @interface ListContractAmendmentResponse
 */
export interface ListContractAmendmentResponse {
    /**
     * 
     * @type {ListContractAmendmentResponseData}
     * @memberof ListContractAmendmentResponse
     */
    'data'?: ListContractAmendmentResponseData;
}
