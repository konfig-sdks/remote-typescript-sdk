...
import { ContractPendingChanges } from './contract-pending-changes';

/**
 * 
 * @export
 * @interface EmploymentContractPendingChangesResponseData
 */
export interface EmploymentContractPendingChangesResponseData {
    /**
     * 
     * @type {Array<ContractPendingChanges>}
     * @memberof EmploymentContractPendingChangesResponseData
     */
