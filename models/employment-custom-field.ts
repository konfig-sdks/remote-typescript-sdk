 ...
 * @export
 * @interface EmploymentCustomField
 */
export interface EmploymentCustomField {
    /**
     * 
     * @type {string}
     * @memberof EmploymentCustomField
     */
    'id'?: string;
    /**
     * 
     ...
     * @memberof EmploymentCustomField
     */
    'type': EmploymentCustomFieldTypeEnum;
}

type EmploymentCustomFieldTypeEnum = 'string' | 'text' | 'integer' | 'date' | 'boolean' | 'percentage' | 'decimal' | 'link' | 'currency' | 'single_select'
