...
import { ListRecurringIncentivesResponseData } from './list-recurring-incentives-response-data';

/**
 * Response schema listing many recurring_incentives
 * @export
 * @interface ListRecurringIncentivesResponse
 */
export interface ListRecurringIncentivesResponse {
    /**
     * 
     * @type {ListRecurringIncentivesResponseData}
     * @memberof ListRecurringIncentivesResponse
     */
    'data'?: ListRecurringIncentivesResponseData;
}
