...
import { CostCalculatorEstimateResponseData } from './cost-calculator-estimate-response-data';

/**
 * 
 * @export
 * @interface CostCalculatorEstimateResponse
 */
export interface CostCalculatorEstimateResponse {
    /**
     * 
     * @type {CostCalculatorEstimateResponseData}
     * @memberof CostCalculatorEstimateResponse
     */
    'data': CostCalculatorEstimateResponseData;
}
