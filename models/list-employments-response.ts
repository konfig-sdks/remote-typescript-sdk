...
import { ListEmploymentsResponseData } from './list-employments-response-data';

/**
 * Response schema listing many employments
 * @export
 * @interface ListEmploymentsResponse
 */
export interface ListEmploymentsResponse {
    /**
     * 
     * @type {ListEmploymentsResponseData}
     * @memberof ListEmploymentsResponse
     */
    'data'?: ListEmploymentsResponseData;
}
