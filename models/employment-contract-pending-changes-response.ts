...
import { EmploymentContractPendingChangesResponseData } from './employment-contract-pending-changes-response-data';

/**
 * 
 * @export
 * @interface EmploymentContractPendingChangesResponse
 */
export interface EmploymentContractPendingChangesResponse {
    /**
     * 
     * @type {EmploymentContractPendingChangesResponseData}
     * @memberof EmploymentContractPendingChangesResponse
     */
    'data': EmploymentContractPendingChangesResponseData;
}
