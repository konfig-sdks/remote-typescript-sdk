...
import { CostCalculatorEstimatePDFResponseData } from './cost-calculator-estimate-pdfresponse-data';

/**
 * 
 * @export
 * @interface CostCalculatorEstimatePDFResponse
 */
export interface CostCalculatorEstimatePDFResponse {
    /**
     * 
     * @type {CostCalculatorEstimatePDFResponseData}
     * @memberof CostCalculatorEstimatePDFResponse
     */
    'data': CostCalculatorEstimatePDFResponseData;
}
