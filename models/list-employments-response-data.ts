...
import { MinimalEmployment } from './minimal-employment';

/**
 * 
 * @export
 * @interface ListEmploymentsResponseData
 */
export interface ListEmploymentsResponseData {
    /**
     * The current page among all of the total_pages
     * @type {number}
     * @memberof ListEmploymentsResponseData
     */
    'current_page'?: number;
    /**
     * 
     * @type {Array<MinimalEmployment>}
     * @memberof ListEmploymentsResponseData
     */
