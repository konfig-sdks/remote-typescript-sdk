...
import { EmploymentCustomFieldValue } from './employment-custom-field-value';

/**
 * 
 * @export
 * @interface EmploymentCustomFieldValueResponseData
 */
export interface EmploymentCustomFieldValueResponseData {
    /**
     * 
     * @type {EmploymentCustomFieldValue}
     * @memberof EmploymentCustomFieldValueResponseData
     */
