...
import { EmploymentCustomField } from './employment-custom-field';

/**
 * 
 * @export
 * @interface ListEmploymentCustomFieldsResponseData
 */
export interface ListEmploymentCustomFieldsResponseData {
    /**
     * The current page among all of the total_pages
     * @type {number}
     * @memberof ListEmploymentCustomFieldsResponseData
     */
    'current_page'?: number;
    /**
     * 
     * @type {Array<EmploymentCustomField>}
     * @memberof ListEmploymentCustomFieldsResponseData
     */
