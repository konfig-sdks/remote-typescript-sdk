...
import { TimeoffBalanceResponseData } from './timeoff-balance-response-data';
...
export interface TimeoffBalanceResponse {
    /**
     * 
     * @type {TimeoffBalanceResponseData}
     * @memberof TimeoffBalanceResponse
     */
    'data': TimeoffBalanceResponseData;
}
