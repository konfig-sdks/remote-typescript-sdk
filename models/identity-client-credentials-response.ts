...
import { IdentityClientCredentialsResponseData } from './identity-client-credentials-response-data';

/**
 * 
 * @export
 * @interface IdentityClientCredentialsResponse
 */
export interface IdentityClientCredentialsResponse {
    /**
     * 
     * @type {IdentityClientCredentialsResponseData}
     * @memberof IdentityClientCredentialsResponse
     */
    'data': IdentityClientCredentialsResponseData;
}
