...
import { CompanyAlreadyExistsErrorResponse } from './company-already-exists-error-response';
import { CompanyNotEligibleForCreationErrorResponse } from './company-not-eligible-for-creation-error-response';

/**
 * @type CompanyCreationConflictErrorResponseMessage
 * @export
 */
export type CompanyCreationConflictErrorResponseMessage = CompanyAlreadyExistsErrorResponse | CompanyNotEligibleForCreationErrorResponse;
