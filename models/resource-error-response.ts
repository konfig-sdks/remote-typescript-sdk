...
import { ResourceErrorResponseMessage } from './resource-error-response-message';
...
export interface ResourceErrorResponse {
    /**
     * 
     * @type {ResourceErrorResponseMessage}
     * @memberof ResourceErrorResponse
     */
    'message': ResourceErrorResponseMessage;
}
