...
import { ListTimeoffTypesResponseData } from './list-timeoff-types-response-data';

/**
 * Time off types response
 * @export
 * @interface ListTimeoffTypesResponse
 */
export interface ListTimeoffTypesResponse {
    /**
     * 
     * @type {ListTimeoffTypesResponseData}
     * @memberof ListTimeoffTypesResponse
     */
    'data'?: ListTimeoffTypesResponseData;
}
