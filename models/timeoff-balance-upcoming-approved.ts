 ...
 * Number of future, approved time off days for the employment, as of today.  You can get a list of approved time off data for this employment using the [list time off endpoint](https://gateway.remote.com/v1/docs/openapi.html). 
 * @export
 */
export type TimeoffBalanceUpcomingApproved = TimeoffDaysAndHours;
