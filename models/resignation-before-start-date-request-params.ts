 ...
 * 
 * @export
 * @interface ResignationBeforeStartDateRequestParams
 */
export interface ResignationBeforeStartDateRequestParams {
    /**
     * 
     * @type {boolean}
     * @memberof ResignationBeforeStartDateRequestParams
     */
