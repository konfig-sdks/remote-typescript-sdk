...
import { ListPayslipsResponseData } from './list-payslips-response-data';

/**
 * Response schema listing many payslips
 * @export
 * @interface ListPayslipsResponse
 */
export interface ListPayslipsResponse {
    /**
     * 
     * @type {ListPayslipsResponseData}
     * @memberof ListPayslipsResponse
     */
    'data'?: ListPayslipsResponseData;
}
