 ...
 * @export
 * @interface ResignationAfterStartDateRequestParamsProposedLastDate
 */
export interface ResignationAfterStartDateRequestParamsProposedLastDate {
    /**
     * 
     * @type {string}
     * @memberof ResignationAfterStartDateRequestParamsProposedLastDate
     */
    'date'?: string;
    /**
     * 
