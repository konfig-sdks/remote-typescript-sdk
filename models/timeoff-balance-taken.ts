 ...
 * Number of time off days taken by the employment as of today.  You can get a list of taken time off data for this employment using the [list time off endpoint](https://gateway.remote.com/v1/docs/openapi.html). 
 * @export
 */
export type TimeoffBalanceTaken = TimeoffDaysAndHours;
