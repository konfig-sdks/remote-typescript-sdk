 ...
 * 
 * @export
 * @interface ListCompanyDepartmentsPaginatedResponseData
 */
export interface ListCompanyDepartmentsPaginatedResponseData {
    /**
     * 
     * @type {Array<CompanyDepartment>}
     * @memberof ListCompanyDepartmentsPaginatedResponseData
     */
