...
import { ContractAmendmentResponseData } from './contract-amendment-response-data';

/**
 * Contract Amendment response
 * @export
 * @interface ContractAmendmentResponse
 */
export interface ContractAmendmentResponse {
    /**
     * 
     * @type {ContractAmendmentResponseData}
     * @memberof ContractAmendmentResponse
     */
    'data'?: ContractAmendmentResponseData;
}
