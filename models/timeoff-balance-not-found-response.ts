...
import { TimeoffBalanceNotSupportedResponse } from './timeoff-balance-not-supported-response';

/**
 * @type TimeoffBalanceNotFoundResponse
 * @export
 */
export type TimeoffBalanceNotFoundResponse = NotFoundResponse | TimeoffBalanceNotSupportedResponse;
