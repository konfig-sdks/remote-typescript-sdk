...
import { BillingDocumentResponseData } from './billing-document-response-data';

/**
 * Information of a billing document
 * @export
 * @interface BillingDocumentResponse
 */
export interface BillingDocumentResponse {
    /**
     * 
     * @type {BillingDocumentResponseData}
     * @memberof BillingDocumentResponse
     */
