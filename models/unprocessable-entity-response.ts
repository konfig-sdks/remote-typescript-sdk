...
import { rror|ParameterError } from './rror|parameter-error';
import { UnprocessableEntityResponseOneOf } from './unprocessable-entity-response-one-of';
import { UnprocessableEntityResponseOneOf1 } from './unprocessable-entity-response-one-of1';

/**
 * @type UnprocessableEntityResponse
 * @export
 */
export type UnprocessableEntityResponse = UnprocessableEntityResponseOneOf | UnprocessableEntityResponseOneOf1;
