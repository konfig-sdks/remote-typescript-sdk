...
import { UpdateIncentiveParamsAllOf } from './update-incentive-params-all-of';

/**
 * @type UpdateIncentiveParams
 * @export
 */
export type UpdateIncentiveParams = CommonIncentiveParams & UpdateIncentiveParamsAllOf;
