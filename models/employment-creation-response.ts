...
import { EmploymentCreationResponseData } from './employment-creation-response-data';

/**
 * 
 * @export
 * @interface EmploymentCreationResponse
 */
export interface EmploymentCreationResponse {
    /**
     * 
     * @type {EmploymentCreationResponseData}
     * @memberof EmploymentCreationResponse
     */
    'data'?: EmploymentCreationResponseData;
}
