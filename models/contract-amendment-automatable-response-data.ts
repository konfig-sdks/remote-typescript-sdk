 ...
 * 
 * @export
 * @interface ContractAmendmentAutomatableResponseData
 */
export interface ContractAmendmentAutomatableResponseData {
    /**
     * If true, it means that the contract amendment request is automatable.
     * @type {boolean}
     * @memberof ContractAmendmentAutomatableResponseData
     */
    'automatable'?: boolean;
    /**
