 ...
 * 
 * @export
 * @interface UnprocessableEntityResponseOneOf1
 */
export interface UnprocessableEntityResponseOneOf1 {
    /**
     * 
     * @type {string | ParameterError | Array<ParameterError> | ActionError | Array<ActionError>}
     * @memberof UnprocessableEntityResponseOneOf1
     */
