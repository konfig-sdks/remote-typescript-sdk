 ...
 * 
 * @export
 * @interface IdentityCustomerAccessTokenResponseData
 */
export interface IdentityCustomerAccessTokenResponseData {
    /**
     * 
     * @type {IdentityCompany}
     * @memberof IdentityCustomerAccessTokenResponseData
     */
