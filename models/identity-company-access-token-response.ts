...
import { IdentityCompanyAccessTokenResponseData } from './identity-company-access-token-response-data';

/**
 * 
 * @export
 * @interface IdentityCompanyAccessTokenResponse
 */
export interface IdentityCompanyAccessTokenResponse {
    /**
     * 
     * @type {IdentityCompanyAccessTokenResponseData}
     * @memberof IdentityCompanyAccessTokenResponse
     */
    'data': IdentityCompanyAccessTokenResponseData;
}
