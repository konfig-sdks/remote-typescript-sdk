...
import { TimeoffDaysAndHours } from './timeoff-days-and-hours';

/**
 * @type TimeoffBalanceUpcomingRequested
 * Number of future, requested time off days for the employment, as of today.  You can get a list of requested time off data for this employment using the [list time off endpoint](https://gateway.remote.com/v1/docs/openapi.html). 
 * @export
 */
export type TimeoffBalanceUpcomingRequested = TimeoffDaysAndHours;
