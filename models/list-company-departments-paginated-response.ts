...
import { ListCompanyDepartmentsPaginatedResponseData } from './list-company-departments-paginated-response-data';

/**
 * 
 * @export
 * @interface ListCompanyDepartmentsPaginatedResponse
 */
export interface ListCompanyDepartmentsPaginatedResponse {
    /**
     * 
     * @type {number}
     * @memberof ListCompanyDepartmentsPaginatedResponse
     */
    'current_page': number;
    /**
     * 
     * @type {ListCompanyDepartmentsPaginatedResponseData}
     * @memberof ListCompanyDepartmentsPaginatedResponse
     */
    'data': ListCompanyDepartmentsPaginatedResponseData;
    /**
     * 
     * @type {number}
     * @memberof ListCompanyDepartmentsPaginatedResponse
