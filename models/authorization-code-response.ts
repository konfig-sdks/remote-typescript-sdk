...
import { AuthorizationCodeResponseAllOf } from './authorization-code-response-all-of';
 ...
 * @export
 */
export type AuthorizationCodeResponse = AuthorizationCodeResponseAllOf & BaseTokenResponse;
