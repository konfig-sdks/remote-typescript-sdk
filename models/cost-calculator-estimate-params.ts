...
import { CostCalculatorEmploymentParam } from './cost-calculator-employment-param';

/**
 * 
 * @export
 * @interface CostCalculatorEstimateParams
 */
export interface CostCalculatorEstimateParams {
    /**
     * Currency Slug
     * @type {string}
     * @memberof CostCalculatorEstimateParams
     */
    'employer_currency_slug': string;
    /**
     * 
     * @type {Array<CostCalculatorEmploymentParam>}
     * @memberof CostCalculatorEstimateParams
     */
