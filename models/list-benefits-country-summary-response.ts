...
import { ListBenefitsCountrySummaryResponseData } from './list-benefits-country-summary-response-data';

/**
 * 
 * @export
 * @interface ListBenefitsCountrySummaryResponse
 */
export interface ListBenefitsCountrySummaryResponse {
    /**
     * 
     * @type {ListBenefitsCountrySummaryResponseData}
     * @memberof ListBenefitsCountrySummaryResponse
     */
