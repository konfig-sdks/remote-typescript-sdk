...
import { CompanyCreationConflictErrorResponseMessage } from './company-creation-conflict-error-response-message';

/**
 * 
 * @export
 * @interface CompanyCreationConflictErrorResponse
 */
export interface CompanyCreationConflictErrorResponse {
    /**
     * 
     * @type {CompanyCreationConflictErrorResponseMessage}
     * @memberof CompanyCreationConflictErrorResponse
     */
    'message'?: CompanyCreationConflictErrorResponseMessage;
}
