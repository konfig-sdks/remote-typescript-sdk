 ...
 * 
 * @export
 * @interface CreateOneTimeIncentiveParamsAllOf
 */
export interface CreateOneTimeIncentiveParamsAllOf {
    /**
     * 
     * @type {string}
     * @memberof CreateOneTimeIncentiveParamsAllOf
     */
