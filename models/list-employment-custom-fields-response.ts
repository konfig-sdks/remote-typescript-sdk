...
import { ListEmploymentCustomFieldsResponseData } from './list-employment-custom-fields-response-data';

/**
 * Response schema listing many custom_fields
 * @export
 * @interface ListEmploymentCustomFieldsResponse
 */
export interface ListEmploymentCustomFieldsResponse {
    /**
     * 
     * @type {ListEmploymentCustomFieldsResponseData}
     * @memberof ListEmploymentCustomFieldsResponse
     */
    'data'?: ListEmploymentCustomFieldsResponseData;
}
