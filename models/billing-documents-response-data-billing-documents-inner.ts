 ...
 * 
 * @export
 * @interface BillingDocumentsResponseDataBillingDocumentsInner
 */
export interface BillingDocumentsResponseDataBillingDocumentsInner {
    /**
     * 
     * @type {string}
     * @memberof BillingDocumentsResponseDataBillingDocumentsInner
     */
     ...
     * @memberof BillingDocumentsResponseDataBillingDocumentsInner
     */
    'billing_document_type'?: BillingDocumentsResponseDataBillingDocumentsInnerBillingDocumentTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof BillingDocumentsResponseDataBillingDocumentsInner
...
type BillingDocumentsResponseDataBillingDocumentsInnerBillingDocumentTypeEnum = 'reconciliation_invoice' | 'prefunding_invoice' | 'supplemental_service_invoice' | 'reconciliation_credit_note'
