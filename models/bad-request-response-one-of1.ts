 ...
 * 
 * @export
 * @interface BadRequestResponseOneOf1
 */
export interface BadRequestResponseOneOf1 {
    /**
     * 
     * @type {BadRequestResponseOneOf1Message}
     * @memberof BadRequestResponseOneOf1
     */
    'message'?: BadRequestResponseOneOf1Message;
}
