...
import { TerminationDetailsParams } from './termination-details-params';

/**
 * 
 * @export
 * @interface CreateOffboardingParams
 */
export interface CreateOffboardingParams {
    /**
     * 
     * @type {string}
     * @memberof CreateOffboardingParams
     */
     ...
     * @memberof CreateOffboardingParams
     */
    'type': CreateOffboardingParamsTypeEnum;
}

type CreateOffboardingParamsTypeEnum = 'termination'
