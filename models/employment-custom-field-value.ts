...
import { EmploymentCustomFieldValueValue } from './employment-custom-field-value-value';

/**
 * EmploymentCustomFieldValue
 * @export
 * @interface EmploymentCustomFieldValue
 */
export interface EmploymentCustomFieldValue {
    /**
     * 
     * @type {string}
     * @memberof EmploymentCustomFieldValue
     */
    'custom_field_id': string;
    /**
     * 
     * @type {EmploymentCustomFieldValueValue}
     * @memberof EmploymentCustomFieldValue
     */
    'value': EmploymentCustomFieldValueValue | null;
}
