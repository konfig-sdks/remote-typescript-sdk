...
import { CostCalculatorEmployment } from './cost-calculator-employment';

/**
 * 
 * @export
 * @interface CostCalculatorEstimateResponseData
 */
export interface CostCalculatorEstimateResponseData {
    /**
     * 
     * @type {Array<CostCalculatorEmployment>}
     * @memberof CostCalculatorEstimateResponseData
     */
