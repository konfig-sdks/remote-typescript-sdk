...
import { IdentityCompany } from './identity-company';
import { IdentityIntegration } from './identity-integration';
import { IdentityUser } from './identity-user';

/**
 * 
 * @export
 * @interface IdentityCompanyAccessTokenResponseData
 */
export interface IdentityCompanyAccessTokenResponseData {
    /**
     * 
     * @type {string}
     * @memberof IdentityCompanyAccessTokenResponseData
     */
    'client_id': string;
    /**
     * 
