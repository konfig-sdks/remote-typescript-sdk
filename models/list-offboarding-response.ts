...
import { ListOffboardingResponseData } from './list-offboarding-response-data';

/**
 * Response schema listing many offboardings
 * @export
 * @interface ListOffboardingResponse
 */
export interface ListOffboardingResponse {
    /**
     * 
     * @type {ListOffboardingResponseData}
     * @memberof ListOffboardingResponse
     */
    'data'?: ListOffboardingResponseData;
}
