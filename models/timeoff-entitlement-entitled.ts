 ...
 * Indicates how much this time off this entitlement contributes to the total time off entitlement. 
 * @export
 */
export type TimeoffEntitlementEntitled = TimeoffDaysAndHours;
