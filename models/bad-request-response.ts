...
import { BadRequestResponseOneOf } from './bad-request-response-one-of';
import { BadRequestResponseOneOf1 } from './bad-request-response-one-of1';
import { BadRequestResponseOneOf1Message } from './bad-request-response-one-of1-message';

/**
 * @type BadRequestResponse
 * @export
 */
export type BadRequestResponse = BadRequestResponseOneOf | BadRequestResponseOneOf1;
