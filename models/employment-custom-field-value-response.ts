...
import { EmploymentCustomFieldValueResponseData } from './employment-custom-field-value-response-data';

/**
 * EmploymentCustomFieldValueResponse
 * @export
 * @interface EmploymentCustomFieldValueResponse
 */
export interface EmploymentCustomFieldValueResponse {
    /**
     * 
     * @type {EmploymentCustomFieldValueResponseData}
     * @memberof EmploymentCustomFieldValueResponse
     */
