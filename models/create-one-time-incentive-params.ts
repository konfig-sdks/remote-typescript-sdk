...
import { CreateOneTimeIncentiveParamsAllOf } from './create-one-time-incentive-params-all-of';

/**
 * @type CreateOneTimeIncentiveParams
 * @export
 */
export type CreateOneTimeIncentiveParams = CommonIncentiveParams & CreateOneTimeIncentiveParamsAllOf;
