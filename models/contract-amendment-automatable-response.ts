...
import { ContractAmendmentAutomatableResponseData } from './contract-amendment-automatable-response-data';

/**
 * Contract Amendment Automatable response
 * @export
 * @interface ContractAmendmentAutomatableResponse
 */
export interface ContractAmendmentAutomatableResponse {
    /**
     * 
     * @type {ContractAmendmentAutomatableResponseData}
     * @memberof ContractAmendmentAutomatableResponse
     */
    'data'?: ContractAmendmentAutomatableResponseData;
}
