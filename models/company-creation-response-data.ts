...
import { CompanyWithTokensResponse } from './company-with-tokens-response';
import { OAuth2Tokens } from './oauth2-tokens';

/**
 * @type CompanyCreationResponseData
 * @export
 */
export type CompanyCreationResponseData = CompanyResponse | CompanyWithTokensResponse;
